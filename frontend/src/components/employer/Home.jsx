...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-green-100 flex flex-col items-center overflow-x-hidden">
      ...
      {/* Action Buttons Row */}
        <div className="w-full max-w-screen-sm px-4 mt-3 flex justify-between gap-2">
          <button className="flex-1 bg-white text-green-800 border border-green-800 font-semibold py-2 rounded-md hover:bg-green-100 transition duration-200">
            My Openings
          </button>
          <button className="flex-1 bg-white text-green-800 border border-green-800 font-semibold py-2 rounded-md hover:bg-green-100 transition duration-200">
            Applications
          ...
          <button
            className="flex-1 bg-white text-green-800 border border-green-800 font-semibold py-2 rounded-md hover:bg-green-100 transition duration-200"
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div className="bg-white rounded-lg shadow-lg p-6 w-11/12 max-w-md relative">
      ...
      >
        ...
        <h2 className="text-xl font-bold text-green-800 mb-4 text-center">New Job Post</h2>
          ...
          <div className="space-y-3 text-sm text-gray-700">
            ...
            <input
              type="text"
              placeholder="Working Hours (e.g., 6 hours/day)"
              value={newJob.hours}
            ...
            <input
              ...
              value={newJob.days}
              onChange={(e) => setNewJob({ ...newJob, days: e.target.value })}
              className="w-full p-2 border border-gray-300 rounded"
            />
            <input
              type="text"
              placeholder="Salary (e.g., LKR 3000/day)"
              value={newJob.salary}
          ...
          <button
            ...
            onClick={() => {
              ...
              setNewJob({ category: "", location: "", hours: "", days: "", salary: "", image: "" });
            }}
          >
            Publish Job
          </button>
