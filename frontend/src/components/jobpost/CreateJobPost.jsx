...
//         <div className="w-24 h-24 bg-blue-100 rounded-lg flex items-center justify-center cursor-pointer border border-blue-400">
...
//           <button type="button" className="bg-blue-300 px-4 py-2 rounded font-bold hover:bg-gray-300">
//             Back
//           </button>
//           <button type="reset" className="bg-blue-400 px-4 py-2 rounded font-bold hover:bg-gray-300">
//             Reset
//           </button>
//           <button type="submit" className="bg-blue-500 px-4 py-2 rounded font-bold hover:bg-gray-300">
//             Publish
//           </button>
//         </div>
//       </div>
...
export default function NewJobForm() {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      // Optional: Use FormData to send to backend
      /*
      const formPayload = new FormData();
      Object.keys(formData).forEach((key) =>
        formPayload.append(key, formData[key])
      );
      formPayload.append("vacancies", vacancies);
      if (imageFile) {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center mb-4">
        <div
          className="w-24 h-24 bg-blue-100 rounded-lg flex items-center justify-center cursor-pointer border border-blue-400 overflow-hidden"
      ...
      <div className="space-y-3">
        ...
        <div className="flex space-x-2">
          <div className="flex-1">
            ...
            />
            {errors.dateFrom && (
              <p className="text-red-500 text-xs">{errors.dateFrom}</p>
            )}
          </div>
          <div className="flex-1">
            <label className="block text-sm font-medium">Date To</label>
            ...
            />
            {errors.dateTo && (
              <p className="text-red-500 text-xs">{errors.dateTo}</p>
            )}
          </div>
        </div>
        ...
        <div className="flex space-x-2">
          <div className="flex-1">
            ...
            />
            {errors.timeFrom && (
              <p className="text-red-500 text-xs">{errors.timeFrom}</p>
            )}
          </div>
          <div className="flex-1">
            <label className="block text-sm font-medium">Time To</label>
            ...
            />
            {errors.timeTo && (
              <p className="text-red-500 text-xs">{errors.timeTo}</p>
            )}
          </div>
        </div>
